(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("js2xmlparser"), require("xml2json"), require("md5"), require("request"), require("url"));
	else if(typeof define === 'function' && define.amd)
		define(["js2xmlparser", "xml2json", "md5", "request", "url"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("js2xmlparser"), require("xml2json"), require("md5"), require("request"), require("url")) : factory(root["js2xmlparser"], root["xml2json"], root["md5"], root["request"], root["url"]);
...
var js2xml = __webpack_require__(1);
var xml2json = __webpack_require__(2);
var md5_1 = __webpack_require__(3);
...
var WechatPay = (function () {
    ...
    WechatPay.prototype._generatorSign = function (obj) {
        ...
        return md5_1.default(sortStr).toUpperCase();
    };
    /**
     * 发起微信支付
    ...
    WechatPay.prototype.payment = function (options, callback) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var modal2xml = js2xml.parse('xml', customerReq);
            request({
                ...
                if (originalData.xml.return_code === 'SUCCESS') {
                    ...
                    wechatPayData.paySign = _this._generatorSign(wechatPayData);
                }
                resolve({
